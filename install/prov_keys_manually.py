...
def register_agent(args):
    ...
    storage_config = json.dumps({"db_name": "wallet", "port": "3306", "write_host": "mysql", "read_host": "mysql", "use_ssl": "true"})
    storage_credentials = json.dumps({"user": "root", "pass" :"password"})
